...
{
	//(string) format string so it can be a concept name
	function conceptNameFormatUcFirst($string)
	{
		return ucfirst(self::conceptNameFormat($string));
	}
	
	//(string) format string so it can be a concept name
	function conceptNameFormat($string)
	{
		$string = trim($string);
