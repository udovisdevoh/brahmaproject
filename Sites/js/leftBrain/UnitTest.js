...
UnitTest.prototype.testAll = function UnitTest_testAll()
{
	...
	//currently: FireFox: 340, Chrome: 135, IE: 3350
	alert("Unit tests completed in " + (endTime.getTime() - startTime.getTime()) + " milliseconds");
}
